...
```bash
vllm bench serve --model qwen25-05b-smoke --host 127.0.0.1 --port 8000 --dataset-name random --random-input-len 128 --random-output-len 32 --num-prompts 16 --request-rate 1 --save-result --result-dir reports/nightly/benchmark/qwen25-05b-smoke
```
