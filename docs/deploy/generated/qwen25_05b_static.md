...
# Qwen2.5 0.5B Static DeployCase Contract Check

## 1. 文档概述

Static Jenkins case used by PR/static flows to validate DeployCase rendering and CLI generation.
...
```bash
vllm serve Qwen/Qwen2.5-0.5B-Instruct --served-model-name qwen25-05b-static --host 127.0.0.1 --port 8001 --max-model-len 2048 --max-num-batched-tokens 2048 --trust-remote-code
```
